...
export function LeafletMap({ plots, selectedPlot, onPlotClick, highlightedPlots, onMapReady }: LeafletMapProps) {
  ...
  useEffect(() => {
    ...
    const fallbackPinIcon = () => L.divIcon({
      ...
      html: `<div class="fallback-pin">
        <svg width="24" height="34" viewBox="0 0 28 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M14 0C6.268 0 0 6.268 0 14c0 10.5 14 26 14 26s14-15.5 14-26C28 6.268 21.732 0 14 0z" fill="#EF4444"/>
          <circle cx="14" cy="14" r="6" fill="#fff" stroke="#DC2626" stroke-width="1.5"/>
        </svg>
      </div>`,
      iconSize: [24, 34],
      iconAnchor: [12, 34],
    ...
    plots.forEach(plot => {
      ...
      polygon.bindTooltip(`
        <div class="p-2 min-w-[180px]">
          ...
          ${isFallbackPlot ? '<div class="text-xs mt-1 px-1.5 py-0.5 rounded" style="background:#EF444422;color:#EF4444;border:1px solid #EF444444">📍 Fallback DB</div>' : ''}
